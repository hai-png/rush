...
| 3 | Contractor verification | License/insurance verification | Legal obligation (Art. 13) | License number, experience, documents (PDF/JPEG/PNG) | Contractors | 7 years (statute of limitations) | N/A | N/A | AES-256 S3 encryption, ClamAV scan |
| 4 | Payment processing | Subscription and one-off ride payments | Contract (Art. 12) | Payment reference, amount, method (Telebirr/CBE) | Riders, Corporate members | 7 years (financial record-keeping) | Telebirr, CBE (subprocessors) | N/A | DPA in place, encrypted channels |
...
| 15 | Analytics & monitoring | Platform improvement, error detection | Legitimate interest (Art. 14) | Usage patterns, error events | Users | 90 days | Sentry (subprocessor) | US (Sentry US region) | DPA in place, data minimization |
...
|-------------|---------|--------------|------------|
| Telebirr | Payment processing | Payment amount, reference, phone | DPA, encrypted channel |
| Africa's Talking | SMS delivery | Phone number | DPA, limited retention |
| Expo | Push notifications | Push token | DPA, data minimization |
| Sentry | Error monitoring | Error context, IP address | DPA, US SCCs |
| Resend | Email delivery | Email address | DPA |
